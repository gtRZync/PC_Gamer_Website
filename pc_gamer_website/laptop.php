...
$result = $conn->query("SELECT * FROM produits WHERE categorie_id = 6");
if (!$result) {
    die("Erreur lors de la récupération des ordinateurs portables: " . $conn->error);
}
...
<head>
    <meta charset="UTF-8">
    <title>PC Portables - ZyncPC</title>
...
<body>
    <header>
        ...
        <div class="top-bar">
            <a href="index.php">
            <img src="logo.png" alt="Logo de la boutique" class="logo">
            </a>
            <nav>
