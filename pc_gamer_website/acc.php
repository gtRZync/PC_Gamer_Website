...
$result = $conn->query("SELECT * FROM produits WHERE categorie_id IN (8, 7)");
if (!$result) {
    die("Erreur lors de la récupération des accesoires: " . $conn->error);
}
